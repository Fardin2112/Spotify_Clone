...
const Player = () => {
  ...
  return track ? (
    <div className="h-[10%] bg-black flex justify-between  items-center text-white px-4 sm:items-start">
      ...
      <div className="flex flex-col  gap-1 m-auto">
        ...
        <div className="flex gap-4  md:hidden">
          ...
          <div className="flex gap-4 ml-14 h-4 mt-4">
          <img
        ...
        <div className="flex items-center gap-5">
          ...
          >
            <hr
              ref={seekBar}
              className="h-1 border-none w-[50%] bg-green-800 rounded-full"
            />
          </div>
          <p>
